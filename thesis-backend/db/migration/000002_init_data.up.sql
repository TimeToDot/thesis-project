...
INSERT INTO privilege(name) VALUES ('CAN_ADMIN_READ');
INSERT INTO privilege(name) VALUES ('CAN_ADMIN_PROJECT');
/*global*/
...
INSERT INTO role_privilege(role_id, privilege_id) select role.id, privilege.id from role, privilege where role.name = 'ROLE_GLOBAL_ADMIN' and privilege.name = 'CAN_ADMIN_PROJECTS';
/*project*/
/*user*/
...
INSERT INTO role_privilege(role_id, privilege_id) select role.id, privilege.id from role, privilege where role.name = 'ROLE_PROJECT_ADMIN' and privilege.name = 'CAN_ADMIN_PROJECT';
...
/*position*/
INSERT INTO position(name, description, status, creation_date) VALUES ('Developer', 'Regular company worker', 'ACTIVE', '2022-12-20 13:02:52.281964');
INSERT INTO position(name, description, status, creation_date) VALUES ('Project Manager', 'Manager of projects', 'ACTIVE', '2022-12-20 13:02:52.281964');
INSERT INTO position(name, description, status, creation_date) VALUES ('Admin', 'Admin of system', 'ACTIVE', '2022-12-20 13:02:52.281964');