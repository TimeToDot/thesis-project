...
import pl.thesis.api.employee.model.task.*;
...
public class EmployeeController extends ThesisController {
    ...
    public ResponseEntity<UUID> updateEmployee(
        ...
        var response = employeeService.updateEmployee(payload);
    ...
    public ResponseEntity<UUID> updatePasswordEmployee(
        ...
        var response = employeeService.updateEmployeePassword(payload);
    ...
    public ResponseEntity<List<UUID>> sendProjectsToApprove(
        ...
        var dto = employeeProjectMapper.mapToDTO(payload, employeeId);

        employeeService.sendProjectsToApprove(dto, payload.startDate(), payload.endDate());
    ...
    public ResponseEntity<UUID> updateTask(
        ...
        var employeeTaskUpdateDTO = employeeTaskUpdatePayloadMapper.mapWithEid(payload, employeeId);
